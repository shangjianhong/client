...
public class AdTestInfo {
	...
	public JSONObject buildAdPopularJson(){
		JSONObject adPopularJson = buildAdJson();
		adPopularJson.put(AdPopular.KEY_FIRST_RECOMMEND, firstRecommend);
		adPopularJson.put(AdPopular.KEY_FIRST_RECOMMEND_IMAGE, firstRecommendImage);
